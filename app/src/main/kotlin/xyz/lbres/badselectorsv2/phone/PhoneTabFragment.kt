...
import xyz.lbres.badselectorsv2.phone.selectincorrect.SelectIncorrectFragment
...
class PhoneTabFragment : TabFragment() {
    ...
    private val selectIncorrectFragment: SelectIncorrectFragment by lazy { SelectIncorrectFragment() }
    ...
    override fun getFragmentFromPosition(position: Int): Fragment {
        return when (position) {
            ...
            1 -> selectCorrectFragment
            2 -> selectIncorrectFragment
    ...
    companion object {
        val metadata = Metadata(
            ...
            listOf(R.string.title_shuffle_circle, R.string.title_select_correct, R.string.title_select_incorrect),
