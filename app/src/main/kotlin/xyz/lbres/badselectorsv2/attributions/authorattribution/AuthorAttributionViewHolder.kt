package xyz.lbres.badselectorsv2.attributions.authorattribution
...
import xyz.lbres.badselectorsv2.attributions.constants.flaticonDisplayUrl
import xyz.lbres.badselectorsv2.attributions.constants.flaticonUrl
import xyz.lbres.badselectorsv2.attributions.imageattribution.ImageAttributionAdapter
...
class AuthorAttributionViewHolder(private val binding: ViewHolderAuthorAttributionBinding) :
    ...
    private fun initializeAttributionText(author: AuthorAttribution) {
        ...
        URLClickableSpan.Companion.addToFirstWord(spannableString, flaticonDisplayUrl, flaticonUrl)
        // link to creator
        URLClickableSpan.Companion.addToFirstWord(spannableString, author.name, author.url)
