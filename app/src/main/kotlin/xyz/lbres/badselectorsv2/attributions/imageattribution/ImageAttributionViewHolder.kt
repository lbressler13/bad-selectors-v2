package xyz.lbres.badselectorsv2.attributions.imageattribution
...
import xyz.lbres.badselectorsv2.databinding.ViewHolderImageAttributionBinding
...
class ImageAttributionViewHolder(private val binding: ViewHolderImageAttributionBinding) :
    ...
    fun update(image: ImageAttribution) {
        ...
        URLClickableSpan.Companion.addToFirstWord(spannableString, image.url, image.url)
